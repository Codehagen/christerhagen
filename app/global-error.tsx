    ...
    <html lang="en">
      <body className="antialiased">
        <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-background px-6 text-center text-foreground">
          <div className="font-mono text-[12px] font-medium tracking-[0.08em] text-(--ink-fainter) uppercase">
            Error
          </div>
          <h1 className="max-w-[20ch] text-[clamp(24px,6vw,30px)] leading-[1.3] font-normal tracking-[-0.015em] text-(--ink-strong)">
            Something went wrong.
          </h1>
          <p className="max-w-[42ch] text-[16px] leading-[1.6] text-(--ink-muted)">
          ...
          <button
            type="button"
            onClick={reset}
            className="mt-2 rounded-full bg-foreground px-[22px] py-[14px] text-[13px] text-background hover:bg-(--rust-deep)"
          >
            Try again
          </button>
        </div>
