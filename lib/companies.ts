...
export const companies: Record<Lang, Record<CompanySlug, Company>> = {
  en: {
    ...
    sailsdock: {
      name: "Sailsdock",
      tagline: "CRM that prioritises sales opportunities for Norwegian teams.",
      role: "Founder",
      stage: "Pre-seed",
      year: "2021",
      sector: "SaaS / CRM",
      ...
      body: [
        "Sailsdock is a CRM built for how Norwegian sales teams actually work. It ranks opportunities by signal instead of gut feeling and automates the busywork around them.",
        "I founded it through Codebase and still build on it day to day.",
      ],
    },
    "advanti-estate": {
      name: "Advanti Estate",
  ...
  no: {
    ...
    sailsdock: {
      name: "Sailsdock",
      tagline: "CRM som prioriterer salgsmuligheter for norske team.",
      role: "Grunnlegger",
      stage: "Pre-seed",
      year: "2021",
      sector: "SaaS / CRM",
      ...
      site: "https://www.sailsdock.no",
      body: [
        "Sailsdock er en CRM bygget for hvordan norske salgsteam faktisk jobber. Den rangerer muligheter etter signal i stedet for magefølelse og automatiserer arbeidet rundt dem.",
        "Jeg grunnla det gjennom Codebase og bygger på det daglig.",
      ],
    },
    "advanti-estate": {
      name: "Advanti Estate",
